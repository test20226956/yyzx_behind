...
public interface NursingRecordDao {
    ...
    List<CustDailyNursingDTO> findByCustomerId(Integer customerId);
    //删除老人的护理记录(批量删除)
    ...
    //添加老人护理记录
    @Insert("insert into yyzx_st.t_nursing_record values (null,#{nursingServiceId},#{customerId},#{time},#{count},#{userId})")
